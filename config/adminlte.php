...
return [
    ...
    */
    ...
    'logo' => 'Positivo',
    'logo_img' => 'image/IconPositivo.png',
    'logo_img_class' => 'brand-image',

    'logo_img_xl' =>'image/Positivo.png',
    ...
    */
    ...
    'register_url' => [
        ...
        'aluno' => 'aluno/register' ,
        'professor' => 'professor/register' ,
    ],

    'password_reset_url' => [
        'admin' => 'admin/password/reset',
        'aluno' => 'aluno/password/reset',
        'professor' => 'professor/password/reset',
    ] ,

    'password_email_url' => [
        'admin' => 'admin/password/email',
        'aluno' => 'aluno/password/email',
        'professor' => 'professor/password/email',
    ],

    // REPLACE BY CONFIG ABOVE
    // 'dashboard_url' => 'home',
    ...
    */
    ...
    'menu' => [
        ['header' => 'Menu Principal' , 'can'         => ['administrador','professores']],
        [
            'text'        => 'Início',
            'url'         => 'professor/home',
            'icon'        => 'fas fa-home',
        ...
        ['header' => 'Controle de Acesso','can'         => ['administrador']],
        [
